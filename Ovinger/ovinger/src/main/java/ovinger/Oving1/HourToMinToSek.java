...
public class HourToMinToSek {
     ...
     * @return The method is returning the number of seconds in the given number of hours.
     */
    ...
    /**
     * This function takes an integer representing a minute value and returns an integer representing
    ...
    /**
     * The function sum takes an array of integers and returns the sum of the integers in the array
     * 
    ...
    /**
     * The function takes in an array of integers, and checks if the integers are within the range of
     * 0-60. If they are, the function returns true. If they are not, the function throws an exception
     * 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < dataSet.length; i++) {
            // Calling the validate method and passing in the values of the array at the index i.
            ...
            int c = convert.sum(new int[] {convert.hourstoSecond(dataSet[i][0]),convert.minuteToSecond(dataSet[i][1]),dataSet[i][2]});
