...
/**
 * It takes two integers from the user, and then prints out the multiplication
 * table for all integers
...
public class Lokke {
    ...
    private void loop(int[] mellom) {
        ...
        int b = 0;
        // Printing out the multiplication table for all integers between the two
        // integers
        do {
