        ...
        while (running) {
            ...
            switch (menuChoice) {
                case 1:
                    ...
                    eiendomsRegister.createRealEstate(municipalityName, municipalityNumber, lotNumber, sectionNumber,
                            name,
                            area, owner);
                    break;
                ...
                case 7:
                    ...
                    System.out
                            .println(eiendomsRegister.getRealEstateByMunicipality(municipalityName2,
                                    municipalityNumber2));
